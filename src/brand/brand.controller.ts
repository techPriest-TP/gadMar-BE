...
export class BrandController {
  ...
  @ApiResponse({ status: 403, description: 'Admin or brand-owner role required' })
  ...
  @ApiOperation({ summary: 'Browse verified gadget brands', description: 'Returns verified brands only. Supports discovery by location and delivery coverage.' })
  @ApiResponse({ status: 200, description: 'Verified brands', type: [BrandResponseDto] })
  findPublic(
  ...
  @ApiResponse({ status: 404, description: 'Verified brand storefront not found' })
  ...
  @ApiResponse({ status: 403, description: 'The brand does not belong to this owner' })
